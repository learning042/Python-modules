...
def print_distinct_achievements(players: list[Player]) -> None:
    distinct = set.union(*(player.get_achievements() for player in players))
...
def main() -> None:
    ...
    for player in players:
        ...
        print()
    print_distinct_achievements(players)
    print()
